...
//****************************************************************************
XBusServo::XBusServo(int dirPin, unsigned int maxServoNum)
{
...
//****************************************************************************
XBusError XBusServo::begin(void)
{
...
//		2014/05/14 : add header by Sawa
//****************************************************************************
XBusError XBusServo::sendCommandDataPacket(char command, char channelID, char order, int* value, char valueSize)
{
	int					sendSize;
	int					recieveSize;
...
//		2014/05/14 : add header by Sawa
//****************************************************************************
XBusError XBusServo::addServo(char channelID, unsigned int initValue)
{
	int			dataOffset;
...
//		2014/05/14 : add header by Sawa
//****************************************************************************
XBusError XBusServo::removeServo(char channelID)
{
	int			dataOffset;
...
//		2014/05/14 : add header by Sawa
//****************************************************************************
XBusError XBusServo::setServo(char channelID, unsigned int value)
{
	int			dataOffset;
...
//		2014/05/14 : add header by Sawa
//****************************************************************************
XBusError XBusServo::setChannelID(char oldChannelID, char newChannelID)
{
	XBusError		result;
	int					value;
...
//		2014/05/14 : add header by Sawa
//****************************************************************************
XBusError XBusServo::setChannelID(char newChannelID)
{
	XBusError		result;
	int					value;
...
//****************************************************************************
int	XBusServo::getDataSize(char	order)
{
	char		dataSize = 1;
...
//		2014/05/15 : add header by Sawa
//****************************************************************************
XBusError XBusServo::setCommand(char channelID, char order, int* value)
{	
...
//		2014/05/15 : add header by Sawa
//****************************************************************************
XBusError XBusServo::getCommand(char channelID, char order, int* value)
{
...
//****************************************************************************
XBusError XBusServo::setCommand(char order, int* value)
{
	if (dirPinNo >= 0)
		return kXBusError_OnlyForTxOnlyMode;
